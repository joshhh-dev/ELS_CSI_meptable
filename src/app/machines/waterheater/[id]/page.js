...
export default function WaterHeaterMachinePage() {
  const { id } = useParams();
  ...
  const renderRow = (label, value) => (
    <tr className="hover:bg-gray-50 transition">
      <td className="px-3 py-2 font-medium text-gray-600 text-sm sm:text-base">{label}</td>
  ...
  return (
    <div className="p-4 sm:p-6 md:p-10 max-w-5xl mx-auto space-y-10">
      ...
      >
        {machine?.imageUrl ? (
          <Image
            ...
            alt={machine.model || "Water Heater Image"}
            fill
      ...
      >
        ...
        <h2 className="text-gray-500 text-sm sm:text-base">{machine.category}</h2>
      ...
      >
        <h2 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6">General Specifications</h2>
        <div className="overflow-x-auto">
          <table className="w-full border-t border-gray-200 text-gray-700 text-sm sm:text-base">
            <tbody>
              ...
              {renderRow("Weight (kg)", machine.weight)}
            </tbody>
          </table>
        </div>
      </motion.section>
      ...
      <motion.section
        ...
        className="border-t pt-6 sm:pt-10"
      >
        <h2 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6">💧 Water</h2>
        <div className="overflow-x-auto">
          <table className="w-full border-t border-gray-200 text-gray-700 text-sm sm:text-base">
            <tbody>
              {renderRow("Cold Water Diameter", machine.coldWater?.diameter)}
              {renderRow("Cold Water Supply Height", machine.coldWater?.supplyWaterHeight)}
              {renderRow("Hot Water Diameter", machine.hotWater?.diameter)}
              {renderRow("Hot Water Supply Height", machine.hotWater?.supplyWaterHeight)}
            </tbody>
          </table>
        </div>
      </motion.section>
      ...
      <motion.section
        ...
        className="border-t pt-6 sm:pt-10"
      >
        <h2 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6">🔥 Gas</h2>
        <div className="overflow-x-auto">
          <table className="w-full border-t border-gray-200 text-gray-700 text-sm sm:text-base">
            <tbody>
      ...
      <motion.section
        ...
        className="border-t pt-6 sm:pt-10"
      >
        <h2 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6">⚡ Electricity</h2>
        <div className="overflow-x-auto">
          <table className="w-full border-t border-gray-200 text-gray-700 text-sm sm:text-base">
            <tbody>
