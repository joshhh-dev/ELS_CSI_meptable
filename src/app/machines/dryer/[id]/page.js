  ...
  useEffect(() => {
    const loadMachine = async () => {
      try {
        ...
        const ref = query(collection(db, "mep_dryers"), where("model", "==", decodedId));
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        {/* Image */}
        <div className="lg:col-span-2 bg-gray-100 rounded-lg flex items-center justify-center overflow-hidden shadow-md">
          {machine.imageUrl ? (
        <Image
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-4 rounded-lg shadow-md">
              ...
              <table className="w-full divide-y divide-gray-200 text-gray-700">
                <tbody>
                  {renderTableRow("Diameter", machine.diameter)}
            ...
            <div className="bg-white p-4 rounded-lg shadow-md md:col-span-2">
              ...
              <table className="w-full divide-y divide-gray-200 text-gray-700">
                <tbody>
                  ...
                  {renderTableRow("Volume - m鲁/h", machine.volumeFlow)}
                </tbody>
              </table>
            </div>
          </div>
